...
- [프로그래밍이란?](#--------)
  ...
  * [연산자](#---)
    + [산술 연산자](#------)
- [자료형](#---)
  * [수치형 자료 (Numeric Type)](#--------numeric-type-)
    + [부동소수점](#-----)
    + [진수 활용](#-----)
  * [문자열 자료형 (String Type)](#---------string-type-)
...
- [시퀀스형 컨테이너](#---------)
  ...
  * [슬라이싱 연산자](#--------)
- [비시퀀스형 컨테이너](#----------)
  * [Set과 Dictionary](#set--dictionary)
  * [형변환이란?](#------)
    + [암시적 변환](#------)
    + [명시적 변환](#------)
    + [컨테이너 형 변환](#---------)
- [프로그램 구성 단위](#----------)
    + [식별자(identifier)와 리터럴(literal)](#----identifier-------literal-)
    + [표현식(expression)과 문장(statement)](#----expression------statement-)
    + [함수](#--)
    + [모듈](#--)
    + [패키지](#---)
    + [라이브러리](#-----)
...
- lst[1][2][3] # 순서가 있는 모든 자료형에 적용 가능
